...
class Trainer:
    ...
    def __init__(self, network, x_train, t_train, x_test, t_test, epochs=20,
        ...
        # optimizer
        optimizer_dict_class = {'sgd': SGD, 'Momentum': Momentum, 'nesterov':Nesterov,
                                'adagrad': AdaGrad, 'rmsprop': RMSprop, 'adam': Adam}
        self.optimizer = optimizer_dict_class[optimizer.lower()](**optimizer_param)
    ...
    def train_step(self):
        ...
        if self.current_iter % self.iter_epoch_num == 0:
